  ...
  return (
    ...
    >
      <svg width="15" height="15" viewBox="0 0 16 16" aria-hidden>
        <path fill="#4285F4" d="M15.68 8.18c0-.57-.05-1.12-.15-1.64H8v3.1h4.3c-.19 1-.76 1.85-1.61 2.42v2h2.6c1.53-1.4 2.4-3.47 2.4-5.88Z" />
        <path fill="#34A853" d="M8 16c2.16 0 3.97-.71 5.29-1.94l-2.6-2c-.72.48-1.64.77-2.69.77-2.07 0-3.82-1.4-4.45-3.27H.87v2.06A8 8 0 0 0 8 16Z" />
