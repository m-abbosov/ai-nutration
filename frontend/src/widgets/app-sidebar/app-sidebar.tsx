...
export function AppSidebar() {
  ...
  const planLabel =
    user?.goal && user.dailyCalorieTarget ? `${t.goalLabel[user.goal]} · ${fmtNumber(user.dailyCalorieTarget, lang)} ${t.kcal}` : t.plan;
  ...
  return (
    ...
    >
      ...
      {!collapsed && <div className="px-2.5 pb-[9px] font-mono text-[9.5px] tracking-[.16em] text-tx3">{t.navSection}</div>}
              ...
              <>
                ...
                {!collapsed && (
                  <>
                    ...
                    {ai && <span className="rounded-[5px] bg-accT px-[5px] py-0.5 font-mono text-[9px] tracking-[.08em] text-acc">AI</span>}
