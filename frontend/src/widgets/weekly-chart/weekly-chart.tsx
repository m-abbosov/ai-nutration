...
function ChartTooltipContent({ active, payload, label, target, t, lang }: ChartTooltipProps) {
  ...
  const deltaLabel = delta === 0 ? t.onT : `${fmtNumber(Math.abs(delta), lang)} ${t.kcal} ${delta > 0 ? t.overT : t.underT}`;
  return (
    <div className="min-w-[132px] rounded-[13px] border border-line2 bg-surf2 px-3.5 py-2.5 shadow-card">
      ...
      <div className="mt-2 flex items-center gap-1.5 border-t border-line pt-2 text-[11.5px]" style={{ color: deltaColor }}>
        ...
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={{ top: 10, right: 4, left: 0, bottom: 0 }} barCategoryGap="24%">
            ...
            <Tooltip
              ...
              content={(props: object) => <ChartTooltipContent {...(props as Partial<ChartTooltipProps>)} target={target} t={t} lang={lang} />}
            />
