...
export default function MacrosPage() {
  ...
  useLogCalculatorUsage("macros", { gender, age: a, heightCm: h, weightKg: w, activityLevel, goal, unit }, result);
          ...
          <>
            ...
            <StatGrid
              cells={[
                ...
                { label: t.app.carbsLabel, value: `${fmtNumber(result.carbsG, lang)} g` },
                { label: t.app.fatLabel, value: `${fmtNumber(result.fatG, lang)} g` },
              ]}
            />
          </>
        ) : (
