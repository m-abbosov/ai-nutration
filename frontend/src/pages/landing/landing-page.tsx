      ...
      <main id="top">
                ...
                <div className="relative overflow-hidden px-[22px] pb-6 pt-[26px]">
                  ...
                  <div className="relative flex flex-wrap items-center justify-center gap-6">
                    <div className="relative h-[186px] w-[186px] flex-none">
                      <div
                        className="animate-halo absolute inset-[14%] rounded-full blur-[20px]"
                      ...
                      <svg viewBox="0 0 240 240" className="relative block h-full w-full" role="img" aria-label={t.landing.hero.a11yRing}>
                        ...
                        <circle
                          ...
                          style={{
                            transition: "stroke-dashoffset 1.6s cubic-bezier(.16,.84,.24,1)",
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                        ...
                        <div className="text-[36px] font-medium leading-[1.08] tracking-[-.035em] [font-variant-numeric:tabular-nums]">
                          {kcalDisplay}
                        </div>
                      ...
                      {macroRows.map((r) => (
                        <div key={r.label}>
                          ...
                          <div className="h-[5px] overflow-hidden rounded-full bg-line">
                            <div
                              className="h-full rounded-full transition-[width] duration-[1300ms]"
                              style={{
                                background: r.col,
                                width: r.w,
                      ...
                      <div key={i} className="flex h-full flex-1 flex-col justify-end gap-1.5">
                        <div className="relative flex flex-1 items-end">
                          <div
                            ...
                            style={{
                              background: i === 6 ? "var(--acc)" : "var(--line2)",
                              height: mounted ? `${((v / 2600) * 100).toFixed(1)}%` : "0%",
                              transitionTimingFunction: "cubic-bezier(.16,.84,.24,1)",
                            }}
                          />
                        </div>
        ...
        <section id="cta" className="mx-auto max-w-[1280px] px-[26px] pb-[52px] pt-8">
          <div
            ...
            style={{ background: "linear-gradient(150deg, var(--accG), var(--line) 44%, var(--line))" }}
          >
              ...
              <div className="relative grid grid-cols-1 items-center gap-[38px] lg:grid-cols-[1.15fr_.85fr]">
                <div className="min-w-0">
                    ...
                    <div className="relative h-[38px] w-[38px] flex-none">
                      ...
                      <div
                        ...
                        style={{
                          ...
                          boxShadow: "inset 0 0 9px rgba(255,255,255,.28)",
                        }}
                      />
                    </div>
                  ...
                  <div className="mt-[26px] flex flex-wrap gap-[11px]">
                    ...
                    <Link
                      to="/login"
                      className="inline-flex items-center rounded-[13px] border border-line2 px-[22px] py-[14px] text-[14px] font-medium text-tx hover:bg-surf2"
                    >
                      {t.landing.cta.btn2}
                    </Link>
                  </div>
                  ...
                  {funnel.map((fn) => (
                    <div key={fn.n} className="flex items-center gap-[13px] rounded-[15px] border border-line bg-bg2 px-4 py-3.5">
                      <span
                        ...
                        style={{
                          background: fn.accent ? "var(--accT)" : "var(--proT)",
                          color: fn.accent ? "var(--acc)" : "var(--pro)",
                        }}
                      >
                        {fn.n}
                      </span>
