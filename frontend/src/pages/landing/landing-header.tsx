...
import { CALCS, CALC_CATEGORY_COLOR, type CalculatorCategory } from '@/entities/calculator/lib/calculators'
import { ChevronDownIcon, BurgerIcon } from './landing-icons'
...
export function LandingHeader() {
  ...
  return (
    <header
      ref={headerRef}
      className="sticky top-0 z-[80] border-b border-line bg-glass backdrop-blur-2xl"
    >
      <div className="mx-auto flex max-w-[1280px] items-center gap-3.5 px-[26px] py-[13px]">
        ...
        <nav aria-label="Main" className="ml-3.5 hidden items-center gap-0.5 lg:flex">
          <a href="#top" className="whitespace-nowrap rounded-[10px] px-3 py-2 text-[13.5px] font-medium text-tx2 transition-colors hover:bg-surf2 hover:text-tx">
            {t.landing.nav.home}
          </a>
          ...
          <a href="#features" className="whitespace-nowrap rounded-[10px] px-3 py-2 text-[13.5px] font-medium text-tx2 transition-colors hover:bg-surf2 hover:text-tx">
            {t.landing.nav.features}
          </a>
          <a href="#how" className="whitespace-nowrap rounded-[10px] px-3 py-2 text-[13.5px] font-medium text-tx2 transition-colors hover:bg-surf2 hover:text-tx">
            {t.landing.nav.how}
          </a>
        </nav>
        ...
        <div className="animate-fu border-t border-line bg-bg2 px-5 pb-[22px] pt-4">
          ...
          <div className="mt-4 flex flex-wrap gap-2 border-t border-line pt-4">
            ...
            <Link
              to="/login"
              onClick={closeAll}
              className="rounded-[11px] bg-acc px-[17px] py-[11px] text-[13px] font-semibold text-[#04120e]"
            >
              {t.landing.nav.getStarted}
            </Link>
          </div>
