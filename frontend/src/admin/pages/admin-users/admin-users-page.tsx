...
import { useAdminTeam } from '@/admin/shared/api/admin-team'
import type { AdminTeamMemberDto } from '@/admin/shared/api/types'
...
import { PromoteUserDialog } from '@/admin/features/promote-user/promote-user-dialog'
    ...
    <div>
      ...
      {isError ? (
        ...
        <DataTable
          ...
          onPageChange={() => {}}
          loading={isLoading}
          onRowClick={(row) => navigate(`/admin/admin-users/${row.id}`)}
