...
import { useAdminAiOverview, useAdminAiRequest, useAdminAiRequests } from '@/admin/shared/api/ai'
import type { AdminAiRequestListItemDto } from '@/admin/shared/api/types'
...
import { StatusBadge, aiStatusToneOf } from '@/admin/shared/ui/status-badge'
import { KpiGridSkeleton, ChartSkeleton, AdminSkeleton } from '@/admin/shared/ui/skeleton'
import { DetailDrawer } from '@/admin/shared/ui/detail-drawer'
...
import type { Range } from '@/admin/shared/api/types'
...
export function AiPage() {
  ...
  return (
    <div>
        ...
        <div className="mt-6">
          ...
          {requests.isError ? (
            ...
            <DataTable
              ...
              onRowClick={(row) => navigate(`/admin/ai/requests/${row.id}`)}
      ...
      <AiRequestDrawer id={openRequestId} onClose={() => navigate('/admin/ai')} />
    </div>
  )
}
