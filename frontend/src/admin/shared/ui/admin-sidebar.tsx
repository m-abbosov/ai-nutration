...
import { useTranslation, langName } from '@/shared/i18n'
import type { Language } from '@/shared/api/types'
import { useAdminAuth } from '@/admin/shared/rbac/admin-auth-context'
import { useAdminTheme } from '@/admin/shared/theme/admin-theme-provider'
...
function SidebarBody({ collapsed, onNavigate }: { collapsed: boolean; onNavigate?: () => void }) {
  ...
  const items: NavItem[] = [
    { to: '/admin', label: t.common.dashboard, icon: LayoutDashboard, permission: 'DASHBOARD_READ' },
    { to: '/admin/users', label: t.common.users, icon: Users, permission: 'USERS_READ' },
    { to: '/admin/nutrition', label: t.common.nutrition, icon: Apple, permission: 'NUTRITION_READ' },
    { to: '/admin/ai', label: t.common.ai, icon: Sparkles, permission: 'AI_READ' },
    { to: '/admin/conversations', label: t.common.conversations, icon: MessagesSquare },
    { to: '/admin/analytics', label: t.common.analytics, icon: BarChart3, permission: 'ANALYTICS_READ' },
    { to: '/admin/system', label: t.common.system, icon: Activity, permission: 'SYSTEM_READ' },
    { to: '/admin/admin-users', label: t.common.adminUsers, icon: ShieldCheck, permission: 'ADMIN_USERS_READ' },
    { to: '/admin/settings', label: t.common.settings, icon: SettingsIcon, permission: 'SETTINGS_MANAGE' },
  ]
