...
export function UsersPage() {
  ...
  const columns: DataTableColumn<AdminUserListItemDto>[] = [
    ...
    {
      key: "mealsCount",
      header: t.users.colMeals,
      align: "right",
      render: (row) => <span className="adm-mono">{fmtNumber(row.mealsCount, lang)}</span>,
    },
    {
      key: "aiRequestsCount",
  ...
  return (
    <div>
      ...
      {pendingStatusChange && <UserStatusConfirm user={pendingStatusChange} onClose={() => setPendingStatusChange(null)} />}
    </div>
  );
}
