 ...
 * scoped to this origin). An admin is just a User row with a role, so a 403
 * here does NOT clear the token: the same account may still be logging in as
 * a regular user on the main app's origin. This provider is UX-only; every
