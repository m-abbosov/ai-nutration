  ...
  'inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-[var(--adm-radius-sm)] text-[12.5px] font-medium transition-colors duration-100 disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2',
  {
    variants: {
      variant: {
        ...
        secondary:
          'border border-[var(--adm-border-strong)] bg-[var(--adm-surface)] text-[var(--adm-text)] hover:bg-[var(--adm-surface-hover)]',
        ...
        outlineDestructive:
          'border border-[var(--adm-critical)] text-[var(--adm-critical)] hover:bg-[var(--adm-critical-subtle)]',
      },
      size: {
        default: 'h-8 px-3',
